...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Vector2 SelectOnWheel
        {
            get
            {
                return SteamVR_Actions.default_SelectOnWheel;
            }
        }
        
        public virtual SteamVR_Action_Boolean ValidateOnWheel
        {
            get
            {
                return SteamVR_Actions.default_ValidateOnWheel;
            }
        }
        
        public virtual SteamVR_Action_Boolean IsSelectingOnWheel
        {
            get
            {
                return SteamVR_Actions.default_IsSelectingOnWheel;
            }
        }
