...
namespace Valve.VR.InteractionSystem.Sample
{
    public class JoeJeffGestures : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (SteamVR_Player.instance == null)
                return;
            ...
            for (int handIndex = 0; handIndex < SteamVR_Player.instance.hands.Length; handIndex++)
            {
                if (SteamVR_Player.instance.hands[handIndex] != null)
                {
                    SteamVR_Behaviour_Skeleton skeleton = SteamVR_Player.instance.hands[handIndex].skeleton;
                    if (skeleton != null)
                    {
