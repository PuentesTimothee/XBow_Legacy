...
namespace Valve.VR.InteractionSystem
{
	...
	//-------------------------------------------------------------------------
	public class SteamVR_Player : MonoBehaviour
	{
		...
		//-------------------------------------------------
		private static SteamVR_Player _instance;
		public static SteamVR_Player instance
		{
			get
			{
				if ( _instance == null )
				{
					_instance = FindObjectOfType<SteamVR_Player>();
				}
				return _instance;
			}
		}
