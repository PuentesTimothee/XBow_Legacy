...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        private SteamVR_Player _steamVrPlayerInstance;
        ...
        public Vector3 GetTrackedObjectVelocity(float timeOffset = 0)
        {
            ...
            {
                if (timeOffset == 0)
                    return SteamVR_Player.instance.trackingOriginTransform.TransformVector(trackedObject.GetVelocity());
                else
                {
                    Vector3 velocity;
                    ...
                    return SteamVR_Player.instance.trackingOriginTransform.TransformVector(velocity);
                }
            }
        ...
        public Vector3 GetTrackedObjectAngularVelocity(float timeOffset = 0)
        {
            ...
            {
                if (timeOffset == 0)
                    return SteamVR_Player.instance.trackingOriginTransform.TransformDirection(trackedObject.GetAngularVelocity());
                else
                {
                    Vector3 velocity;
                    Vector3 angularVelocity;
                    ...
                    trackedObject.GetVelocitiesAtTimeOffset(timeOffset, out velocity, out angularVelocity);
                    return SteamVR_Player.instance.trackingOriginTransform.TransformDirection(angularVelocity);
                }
            }
        ...
        public void GetEstimatedPeakVelocities(out Vector3 velocity, out Vector3 angularVelocity)
        {
            ...
            velocity = SteamVR_Player.instance.trackingOriginTransform.TransformVector(velocity);
            angularVelocity = SteamVR_Player.instance.trackingOriginTransform.TransformDirection(angularVelocity);
        }
        ...
        protected virtual IEnumerator Start()
        {
            ...
            _steamVrPlayerInstance = SteamVR_Player.instance;
            if (!_steamVrPlayerInstance)
            {
